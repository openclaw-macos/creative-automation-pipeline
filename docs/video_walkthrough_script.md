...
**Length:** 4-5 minutes
**Audience:** Technical users, developers, marketing teams
**Goal:** Demonstrate the pipeline's architecture, setup, and workflow.
...
**Speaker:**
"To make setup easy, I’ve included six ready‑to‑run campaign briefs covering major global regions.
